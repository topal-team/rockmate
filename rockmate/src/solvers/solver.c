...
static PyTypeObject RkTableType = {
  ...
  .tp_name = "rockmate.solvers.csolver.RkTable",
...
static struct PyModuleDef rotor_solver_module = {
    ...
    "rockmate.solvers.csolver",   /* name of module */
...
PyInit_csolver(void)
{
  ...
  PyObject* seq_module_name = PyUnicode_DecodeFSDefault("rockmate.solvers.csequence");
