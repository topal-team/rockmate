...
class integral_kernel_block(nn.Module):
    ...
    def __init__(self, width, modes1,modes2,modes3,is_gelu=True):
...
class FNO3d(nn.Module):
    def __init__(self, modes1,modes2,modes3, width,block_number=4):
        ...
        self.add_module('linear', preprocess_block(self.width,self.padding))
        
        for i in range(0,block_number-1):
          self.add_module('kernel_layer_'+str(i), integral_kernel_block(self.width,self.modes1,self.modes2,self.modes3,is_gelu=True))
        self.add_module('kernel_layer_'+str(block_number-1),integral_kernel_block(self.width,self.modes1,self.modes2,self.modes3,is_gelu=False))
